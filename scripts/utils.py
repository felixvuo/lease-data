# These columns usually identify an instance in most datasets
ID_COLS = ['ProblemDir', 'ParamFile']

# The columns we store from the .info files after the execution of all
# runs with all configs
TIMING_COLS = [
    'ProblemDir', 'ParamFile', 'EncSum', 'EncPB', 'Encs', 'Run',
    'SATClauses', 'SATVars',
    'SavileRowClauseOut', 'SavileRowTimeOut', 'SavileRowTotalTime',
    'SolverMemOut', 'SolverSatisfiable', 'SolverTimeOut', 'SolverTotalTime'
]

# The features provided by the fzn2feat project
# https://github.com/CP-Unibo/mzn2feat/tree/master/fzn2feat
FZN_FEATS_DESCR = {
...
FZN_FEATURES = sorted(FZN_FEATS_DESCR.keys())
